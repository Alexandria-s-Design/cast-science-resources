#!/usr/bin/env python3
"""
ModelIt! Batch Generator - Grade 9 (Levels 1, 2, 3)

Usage:
    python create_all_lessons_G09.py 1      # Generate Level 1 only
    python create_all_lessons_G09.py 2      # Generate Level 2 only
    python create_all_lessons_G09.py 3      # Generate Level 3 only
    python create_all_lessons_G09.py 1 2 3  # Generate all levels
    python create_all_lessons_G09.py        # Generate all levels (default)
"""
...
AGE_RANGE = "14-15 years old"

LEVEL_CONFIG = {
    1: {
        "label": "9th Grade \u2014 Level 1: Foundations",
        "short": "Level 1: Foundations of Computational Modeling",
        "base_dir": os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'materials', 'grade-09', 'level-1'),
        "import": "lesson_data_G09_L1",
    },
    2: {
        "label": "9th Grade \u2014 Level 2: Advanced",
        "short": "Level 2: Advanced Computational Modeling",
        "base_dir": os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'materials', 'grade-09', 'level-2'),
        "import": "lesson_data_G09_L2",
    },
    3: {
        "label": "9th Grade \u2014 Level 3: Biotech",
        "short": "Level 3: Biotech Modeling & Simulation",
        "base_dir": os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'materials', 'grade-09', 'level-3'),
        "import": "lesson_data_G09_L3",
    },
}
...
def run_level(level_num):
    ...
    print(f"\n{'='*60}")
    print(f"ModelIt! Batch Generator - Grade 9 {cfg['short']}")
    print(f"{'='*60}")
...
if __name__ == "__main__":
    ...
    print("="*60)
    print("ModelIt! Grade 9 Generator")
